...
const fallbackProjects = [
  ...
  },
  {
    ...
    tech_stack: ["React", "TypeScript", "Storybook", "Design Tokens", "Figma", "CSS-in-JS", "Component Library"],
    ...
    logo: "PS",
    logoType: "text",
    headline: "Pepe Design System",
    subline: "Scalable Component Library",
    features: ["60% Faster Dev", "Brand Consistency", "Storybook Docs"]
  },
  {
    id: "13",
    ...
    logo: "BF",
    logoType: "text",
    headline: "Bavaria Finance",
    subline: "Conversion Optimized",
    features: ["340% More Leads", "Trust Building", "SEO Optimized"]
  },
  {
    id: "1",
    title: "Senflix",

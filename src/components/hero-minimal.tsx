          ...
          >
            ...
            <div className="max-w-2xl mx-auto space-y-4">
              <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed">
                ...
                <br />
                <strong className="text-foreground">Full-package delivery</strong> from idea to launch.
              </p>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <blockquote className="text-lg italic text-foreground/90 text-left">
                "Every pixel serves purpose. Every line of code carries intention. 
                In the intersection of design and engineering lies the future of rapid innovation."
              </blockquote>
            </div>
          </motion.div>
